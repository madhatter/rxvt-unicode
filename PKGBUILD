# Maintainer: Arvid Warnecke <arvid[at]nostalgix[dot]org>
...
# This package is a direct copy of the community archlinux package_rxvt-unicode with pixbuf enabled.
# The AUR package rxvt-unicode-pixbuf was out-dated and my fonts looked weird, so I re-compiled the package I used so far.
# The version number is kept the same as the community package and I set IgnorePkg in /etc/pacman.conf to get notified about changes. ;)
...
license=('GPL')
makedepends=('libxft' 'perl' 'startup-notification' 'libnsl' 'gdk-pixbuf2')
